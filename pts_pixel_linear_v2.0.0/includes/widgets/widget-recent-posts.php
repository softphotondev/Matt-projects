...
class azkaban_Recent_Posts_Thumbnails extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_recent_entries', 'description' => __( "The most recent posts with thumbnails on your blog", 'azkaban_options') );
		parent::__construct('recent-posts', __('Azkaban: Latest Posts with Thumbnails', 'azkaban_options'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'azkaban_options') : $instance['title']);
