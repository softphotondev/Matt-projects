    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'azkaban_options' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'azkaban_options' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'azkaban_options' ),
                        ...
                        foreach ( $section['fields'] as $field ) {
                            if ( isset( $field['type'] ) ) {
                                ...
                                if ( ! class_exists( $field_class ) ) {
                                    $class_file = apply_filters( 'redux-typeclass-load', $this->path . 'inc/fields/' . $field['type'] . '/field_' . $field['type'], $field_class );
                                    if ( $class_file ) {
                                        /** @noinspection PhpIncludeInspection */
                                        get_template_part( $class_file );
                                    }
                                }
