...
if (!function_exists('gents_setup')):
    ...
    function gents_setup() {
	    ...
	    load_theme_textdomain('azkaban_options', get_template_directory().'/languages');
...
function gents_read_more() {
    ...
    return ' <a href="' . get_permalink() . '">' . __('<div class="read-more"><p>Read more &#8250;</p></div><!-- end of .read-more -->', 'azkaban_options') . '</a>';
...
function gents_breadcrumb_lists() {
    ...
    $name = __('Home','azkaban_options'); //text for the 'Home' link
    ...
    if (is_category()) {
        ...
        echo $currentBefore . __('Search results for &#39;','azkaban_options') . get_search_query() . __('&#39;','azkaban_options') . $currentAfter;

    } elseif (is_tag()) {

        echo $currentBefore . __('Posts tagged &#39;','azkaban_options');
        ...
        echo $currentBefore . __('Articles posted by ','azkaban_options') . $userdata->display_name . $currentAfter;

    } elseif (is_404()) {

        echo $currentBefore . __('Error 404','azkaban_options') . $currentAfter;
    ...
    if (get_query_var('paged')) {
        ...
        echo __('Page','azkaban_options') . ' ' . get_query_var('paged');
    ...
    function gents_title($title) {
        ...
        if ($title == '') {
            ...
            return __('Untitled','azkaban_options');
    ...
    function gents_widgets_init() {
		 ...
		 register_sidebar(array(
            ...
            'name' => __('Left Sidebar', 'azkaban_options'),

            'description' => __('Left Sidebar Contents', 'azkaban_options'),
            ...
            'before_widget' => '<div id="%1$s" class="sidebar-wrapper %2$s">',
		 ...
		 register_sidebar(array(
            ...
            'name' => __('Right Sidebar', 'azkaban_options'),

            'description' => __('Right Sidebar Contents', 'azkaban_options'),
          ...
          register_sidebar(array(
            ...
            'description' => __('footer.php', 'azkaban_options'),
		...
		register_sidebar(array(
            'name' => __('Box One', 'azkaban_options'),
            'description' => __('Three Box Content', 'azkaban_options'),
            'id' => 'box-1',
		...
		register_sidebar(array(
            'name' => __('Box Two', 'azkaban_options'),
            'description' => __('Three Box Content', 'azkaban_options'),
            'id' => 'box-2',
            'before_title' => '<div class="box-title"><h3>',
            'after_title' => '</h3></div>',
		...
		register_sidebar(array(
            'name' => __('Box Three', 'azkaban_options'),
            'description' => __('Three Box Content', 'azkaban_options'),
            'id' => 'box-3',
            'before_title' => '<div class="box-title"><h3>',
            'after_title' => '</h3></div>',
